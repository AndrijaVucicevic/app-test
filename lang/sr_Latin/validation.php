...
return [
    ...
    */
    ...
    'digits_between' => 'Polje :attribute mora sadržati između :min i :max cifara.',
    ...
    */
    ...
    'custom' => [
        ...
        'registration_plate' => [
            'alpha_num' => 'Registarska tablica nije ispravnog formata. Možete koristiti samo slova i brojeve.',
        ],
        'category' => [
            'in' => 'Kategorija ne postoji. Kategorija može imati samo sledeće vrednosti: 1,2,3,4.',
        ],
        'import_keys' => [
            'required' => 'Morate izabrati fajlove na osnovu kojih će se generisati računi.',
        ],
        'vehicle' => [
            'required' => 'Morate uneti registarske tablice.',
        ],
        'cardholder_name' => [
            'required_if' => 'Polje Ime je obavezno.'
        ],
        'cardholder_surname' => [
            'required_if' => 'Polje Prezime je obavezno.'
        ],
        'company_name' => [
            'required_if' => 'Polje Naziv firme je obavezno.'
        ],
        'mb' => [
            'required_if' => 'Polje Matični broj je obavezno.'
        ],
    ],
